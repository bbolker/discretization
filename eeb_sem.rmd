---
title: "Overcoming bad statistical-ecological advice for multifactorial systems"
author: "Ben Bolker"
date: "11 March 2020"
...
- [poll](https://www.polleverywhere.com/multiple_choice_polls/8JW59IQWaWnipW6USbYW8)
- text `BENBOLKER2272` to `22333` or go to https://pollev.com/benbolker2272
...
```{r free_lunch}
if (file.exists("pix/free_lunch.jpg")) {
  knitr::include_graphics("pix/free_lunch.jpg")
}
```
...
- is it OK to select on non-focal aspects of the model? e.g.
    - interactions
