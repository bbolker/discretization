---
title: "Avoiding premature discretization in a multifactorial world"
output:
  beamer_presentation:
    slide_level: 2
    keep_tex: true
...
## what questions is applied statistics/machine learning/etc. trying to answer?

- **prediction**: what is the expected outcome in a specified scenario?
- **inference**: what factors are affecting observed outcomes, and how much?
   - (alternately: prediction/estimation of effects **with uncertainty bounds**)
   
## what is (premature) discretization? why do we care?

- often consider *point hypotheses*, often as *counterfactual null hypotheses*  
(e.g. "delta variant has the same $R_0$ as earlier variants"; "masks do not prevent COVID transmission")
   - never (?) true in biology/psychology/economics/epidemiology ...
- "strong inference" [@platt_strong_1964]: (binary, discrete) alternative hypotheses 
- testing among *many* discrete hypotheses (e.g. @taper_evidential_2015)
...
- null hypothesis testing as measure of \cemph{clarity} (OK: [@dushoff_i_2019])
- "feature/variable selection" in machine learning/prediction (OK as a shortcut)
- 
